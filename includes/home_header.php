        ...
        <div class="row align-items-center">
          <div class="col-12 col-lg-6 d-flex">
            <a href="" class="site-logo">
              ...
              <p style="font-size: 42%;text-align: center">| Perspectives Behind The Story |</p>
            </a>
          ...
          <div class="col-12 col-lg-6 ml-auto d-flex">
            ...
            <form action="search.php" class="search-form d-inline-block">
          ...
          <div class="mr-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
                <ul class="site-menu main-menu js-clone-nav mr-auto d-none pl-0 d-lg-block">
                    ...
                    <li>
                  <a  href="category" class="nav-link text-left" style="color: white;background-color: black; border-radius: 20px; ">Category</a>
                </li>
                 
               
                <li>
                    <a href="about_us" class="nav-link text-left" style="color: black;background-color: white; border-radius: 20px;">About</a>
                </li>
                <li><a href="contact" class="nav-link text-left" style="color: white;background-color: black; border-radius: 20px;">Contact</a></li>
				<li><a href="corona" class="nav-link text-left" style="color: black;background-color: white; border-radius: 20px;">Corona Update</a></li>
                ...
                <?php
                 ...
                 <li>
                    <a href="logout" class="nav-link text-left" style="color: black;background-color: white; border-radius: 20px;">Logout</a>
                </li>
                <?php 
                  }
                  else
